...
% utilizzando una struttura a tab verticali. Nessuna logica è collegata.
% Ogni tab è separato e predisposto per futura integrazione funzionale.
...
function staticGestureRecognitionUI()
    ...
    uibutton(fig, 'Text', '◀ Torna alla schermata principale', ...
    ...
    uibutton(tabVector, 'Text', '✍ Inserisci manuale', 'Position', [20 490 260 40], ...
        'ButtonPushedFcn', @(~,~) disp('TODO: input manuale'));
    uibutton(tabVector, 'Text', '📁 Carica .mat', 'Position', [300 490 260 40], ...
        'ButtonPushedFcn', @(~,~) disp('TODO: carica .mat'));
    uibutton(tabVector, 'Text', '📁 Classifica vettori', 'Position', [580 490 260 40], ...
    ...
    lblVector = uilabel(tabVector, 'Text', 'Risultato: –', 'Tag', 'ResultLabelVector', ...
    ...
    %% === TAB 4 – Cronologia (solo tabella e log) ===
    ...
    uibutton(tabSession, 'Text', '📁 Carica sessione', 'Position', [20 250 260 40], ...
        'FontSize', 14, 'ButtonPushedFcn', @(~,~) disp('TODO: carica sessione'));
    uibutton(tabSession, 'Text', '💾 Salva sessione', 'Position', [315 250 260 40], ...
        'FontSize', 14, 'ButtonPushedFcn', @(~,~) disp('TODO: salva sessione'));
    uibutton(tabSession, 'Text', '📤 Esporta CSV', 'Position', [605 250 260 40], ...
        'FontSize', 14, 'ButtonPushedFcn', @(~,~) disp('TODO: esporta CSV'));
    uibutton(tabSession, 'Text', '🧹 Pulisci cronologia', 'Position', [900 250 260 40], ...
    ...
    % Allinea i tag usati dalla logica (no-op se già coincidono)
    ...
    btnLoadImg      = findobj(fig, 'Text', '📂 Carica immagine');
    btnClassifyOne  = findobj(fig, 'Text', '▶ Classifica immagine');
    btnClassifyAll  = findobj(fig, 'Text', '📁 Classifica tutto');
    ...
    % Selezione riga cronologia → ricarica anteprima
    ...
    %% ===== Wiring TAB 3 =====
    btnVec1 = findobj(fig,'Text','✍ Inserisci manuale');
    btnVec2 = findobj(fig,'Text','📁 Carica .mat');
    btnVec3 = findobj(fig,'Text','📁 Classifica vettori');
